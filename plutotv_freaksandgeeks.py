...
# Inicializa o client do Streamlink (não existia antes)
session = Streamlink()
...
def generate_m3u_playlist():
    ...
    for ep in EPISODES:
        ...
        # Aqui, antes, o Python **não buscava** a m3u8: ele apenas
        # construía a URL do master.m3u8 e já adicionava no .m3u
        m3u_content += (
